...
export const brandMessagesFixtureEn: BrandMessages = {
  ...
  siteSearch: {
    ...
    submit: 'Search',
    idle: 'Type to search the whole site',
    minLength: (min) => `Type at least ${min} characters`,
    pending: 'Press Enter to search',
    loading: 'Searching…',
    results: (count, query) =>
    ...
    errorDescription: 'The search service did not respond. Try again in a few seconds.',
    retry: 'Try again',
  },
  docsSearch: {
  ...
  recurrenceField: {
    ...
    endNever: 'Never',
    endUntil: 'On a date',
    endCount: 'After a number of times',
    until: 'Until',
