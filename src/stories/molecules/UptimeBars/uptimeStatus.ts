/*
 * La regla de los tramos, aparte del componente: son datos y una función pura,
 * y el consumidor los necesita para pintar una leyenda o un resumen con los
 * mismos cortes que la tira.
 */
 ...
 */
export const UPTIME_BARS_DEFAULT_THRESHOLDS: Required<UptimeBarsThresholds> = {
  ok: 99.65,
  degraded: 95.83,
};

/** El tramo de un punto según los cortes. `null` no es 0 %: es la ausencia de medida. */
export function uptimeStatus(value: number | null, thresholds: Required<UptimeBarsThresholds>): UptimeBarsStatus {
