...
export const Default: Story = {
  args: {
    actions: <Button variant="primary" block>Enviar</Button>,
    children: (
...
export const ContactFormExample: Story = {
  ...
  render: () => {
    ...
    return (
      <Form
        actions={<Button variant="primary" block type="submit">Enviar mensaje</Button>}
      >
...
export const NewsletterFormExample: Story = {
  ...
  render: () => (
    <Form
      actions={<Button variant="primary" block type="submit">Suscríbeme a la newsletter</Button>}
    >
