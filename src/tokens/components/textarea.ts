...
export const textareaBaseTokens     = all.filter(t => !t.name.match(/--textarea-(focus|error|disabled|dark|sm|lg)/));
...
export const textareaSizeTokens     = all.filter(t => t.name.match(/--textarea-(sm|lg)-/));
