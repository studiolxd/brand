...
export declare function AsyncSelectField({ id, label, labelHidden, onSearch, value, onValueChange, selectedOption, placeholder, disabled, readOnly, size: sizeProp, error, errorMessage, helperText, }: AsyncSelectFieldProps): import("react/jsx-runtime").JSX.Element;
