...
export declare function AsyncMultiSelectField({ id, label, labelHidden, onSearch, value, defaultValue, onValueChange, selectedOptions, placeholder, disabled, readOnly, size: sizeProp, error, errorMessage, helperText, }: AsyncMultiSelectFieldProps): import("react/jsx-runtime").JSX.Element;
