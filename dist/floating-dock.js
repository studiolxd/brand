...
function c({ label: c, title: l, titleHidden: u = !1, description: d, children: f, icon: p, position: m = "bottom-end", open: h, defaultOpen: g, onOpenChange: _, closeLabel: v = "Cerrar", badge: y = 0, badgeMax: b = 99, badgeLabel: x = (e) => `${e} mensajes nuevos`, badgeLive: S = !0, dismissOnOutsidePress: C = !1, className: w, ...T }) {
	...
	return /* @__PURE__ */ a("div", {
		...
		children: /* @__PURE__ */ o(s.Root, {
			...
			onOpenChange: (e) => _?.(e),
			children: [
				/* @__PURE__ */ a(s.Trigger, { render: /* @__PURE__ */ o(n, {
					variant: "primary",
					size: "lg",
					iconOnly: !0,
					"aria-label": c,
					...
					children: /* @__PURE__ */ o(s.Popup, {
						...
						children: [
							/* @__PURE__ */ o("header", {
								...
								children: [u ? /* @__PURE__ */ a(s.Title, { render: /* @__PURE__ */ a(t, { children: l }) }) : /* @__PURE__ */ a(s.Title, {
									className: "floating-dock__title",
									children: l
								}), d != null && /* @__PURE__ */ a(s.Description, {
