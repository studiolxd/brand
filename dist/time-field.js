...
function i({ id: i, label: a, labelHidden: o = !0, value: s, onChange: c, step: l, size: u, disabled: d, readOnly: f, error: p = !1, errorMessage: m, helperText: h, dark: g }) {
	let _ = m ? `${i}-error` : void 0, v = h ? `${i}-helper` : void 0;
