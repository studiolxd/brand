...
var o = i(function({ items: i, activeId: o, ariaLabel: s = "En esta página", title: c, sticky: l = !1, onItemClick: u, className: d }, f) {
	if (i.length === 0) return null;
	let p = Math.min(...i.map((e) => e.level));
		...
		children: [c && /* @__PURE__ */ n("p", {
			...
			children: i.map((t) => {
				...
				return /* @__PURE__ */ n("li", {
					className: `table-of-contents__item table-of-contents__item--level-${a(t.level, p)}`,
