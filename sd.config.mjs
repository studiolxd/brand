...
const filters = {
  ...
  fieldset:         (t) => t.path[0] === 'fieldset',
  'filter-bar':     (t) => t.path[0] === 'filter-bar',
  'page-intro':     (t) => t.path[0] === 'page-intro',
  ...
  'notification-panel':  (t) => t.path[0] === 'notification-panel',
  'notification-list':   (t) => t.path[0] === 'notification-list',
  ...
  'copyable-value':     (t) => t.path[0] === 'copyable-value',
  ...
  'public-page-shell':  (t) => t.path[0] === 'public-page-shell',
  ...
  platforms: {
    css: {
      ...
      files: [
        ...
        cssFile('components/fieldset.css',         'fieldset'),
        ...
        cssFile('molecules/filter-bar.css',        'filter-bar'),
        cssFile('molecules/page-intro.css',        'page-intro'),
        ...
        cssFile('molecules/notification-panel.css',  'notification-panel'),
        cssFile('molecules/notification-list.css',   'notification-list'),
        ...
        cssFile('components/step.css',                'step'),
        ...
        cssFile('molecules/banner.css',             'banner'),
        ...
        cssFile('components/copyable-value.css',   'copyable-value'),
        ...
        cssFile('molecules/public-page-shell.css', 'public-page-shell'),
    ...
    scss: {
      ...
      files: [
        ...
        scssFile('components/_fieldset.scss',         'fieldset'),
        ...
        scssFile('molecules/_filter-bar.scss',        'filter-bar'),
        scssFile('molecules/_page-intro.scss',        'page-intro'),
        ...
        scssFile('molecules/_notification-panel.scss',  'notification-panel'),
        scssFile('molecules/_notification-list.scss',   'notification-list'),
        ...
        scssFile('components/_step.scss',                'step'),
        ...
        scssFile('molecules/_banner.scss',              'banner'),
        ...
        scssFile('components/_copyable-value.scss',    'copyable-value'),
        ...
        scssFile('molecules/_public-page-shell.scss', 'public-page-shell'),
